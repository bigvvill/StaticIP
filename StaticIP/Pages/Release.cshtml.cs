...
namespace StaticIP.Pages
{
    public class ReleaseModel : PageModel
    {
        ...
        public ReleaseModel(IConfiguration configuration)
        {
        ...
        public IActionResult OnPost()
        {
            ...
            using (var connection = new SqliteConnection(_configuration.GetConnectionString("ConnectionString")))
            {
                ...
                var tableCmd = connection.CreateCommand();
                tableCmd.CommandText =
                    $"UPDATE ip_database SET VFourAddress ='{IpAddress.VFourAddress}', InUse = 0 WHERE Id = {IpAddress.Id}";
            ...
            return RedirectToPage("./ReleaseIP");
        }
    }
}
